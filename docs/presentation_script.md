...
* **Lời thoại:**
  ...
  > Buổi hôm nay mình sẽ đi qua bối cảnh, câu hỏi nghiên cứu, kiến trúc hệ thống và kế hoạch chạy 4 Sprints cụ thể để cả team nắm rõ vai trò của mình và bắt tay vào làm luôn nhé."

---

### Slide 2: Bối cảnh & Mục tiêu dự án
* **Lời thoại:**
  ...
  > Mục tiêu của chúng ta là dựng lên một hệ thống đo đạc thực tế để tìm ra điểm Pareto tối ưu — tức là điểm mà nén được nhiều bộ nhớ nhất nhưng chất lượng tiếng Việt ít bị suy giảm nhất để khuyến nghị cho các doanh nghiệp."
...
* **Lời thoại:**
  ...
  > - **4 mô hình:** PhoGPT-7B5 (mô hình thuần Việt của VinAI), Qwen2.5-7B, Llama-3.1-8B, và Vistral-7B làm đối chứng.
...
* **Lời thoại:**
  ...
  > - Mình (Kiến Hưng) và Việt Anh sẽ chịu trách nhiệm điều phối tiến độ và tổng hợp báo cáo.
  > - Team Tech gồm Quân (Tech Lead), Khánh và Duy (chuyên về lượng tử hóa và xử lý lỗi phần cứng).
