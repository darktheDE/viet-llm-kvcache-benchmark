...
* **Lời thoại:**
  ...
  > - **5 mô hình:** gemma4:e4b (Qwen2.5 7B đa ngôn ngữ), qwen3:8b (Qwen3 8B), llama3.2:3b (Llama 3.2 3B compact baseline), arcee-ai/Arcee-VyLinh (Mistral 7B đối chứng), và Qwen/Qwen2.5-7B-Instruct-1M (long-context upper-bound).
