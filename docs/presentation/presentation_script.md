...
* **Lời thoại:**
  ...
  > - **4 mô hình:** qwen3:8b-fp16 (Qwen3 8B), llama3.1:8b-instruct-fp16 (Llama 3.1 8B), mistral:7b-instruct-v0.3-fp16 (Mistral 7B đối chứng GQA), và qwen2.5:7b-instruct-fp16 (Qwen2.5 7B). Gemma 4 được loại khỏi scope vì đã có tối ưu nén sẵn, không còn là baseline công bằng cho phép so sánh này.
...
* **Lời thoại:**
  ...
  > - Team Writing & Coordination gồm mình (Kiến Hưng), Phan Trọng Quí, Phan Trọng Phú và Nguyễn Văn Quang Duy; nhóm chịu trách nhiệm điều phối tiến độ, tổng hợp báo cáo và phối hợp kỹ thuật liên team.
  > - Team Tech gồm Quân (Tech Lead), Việt Anh và Khánh.
