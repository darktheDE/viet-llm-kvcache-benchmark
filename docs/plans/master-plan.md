...
*   **Nhiệm vụ chi tiết:**
    *   *Kỹ thuật & Thử nghiệm (Nhóm phân vai 1-2 mô hình/người):*
        *   **Cặp 1 (Việt Anh, Minh Quân):** Chạy thực nghiệm trên mô hình `Sailor2-8B-Chat`.
...
| **Hồ Việt Anh** | Technical & Experiment | **R** (Cloud Setup) | **R** (Sailor2-8B) | **C** | **C** |
| **Phạm Minh Quân** | Tech Lead / Optimizer | **R** (CUDA setup) | **R** (Sailor2-8B) | **C** | **C** |
